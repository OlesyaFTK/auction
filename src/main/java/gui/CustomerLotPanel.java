 ...
 * @author Олеся
 */
public class CustomerLotPanel extends javax.swing.JPanel {

    /**
     * Creates new form CustomerLotPanel
     */
    public CustomerLotPanel(Lot lot,User user) {
        initComponents();
        this.lot = lot;
        this.user = user;
        setLot();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new AddBidFrame(lot,user).setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new RateFrame(lot.getSeller()).setVisible(true);
